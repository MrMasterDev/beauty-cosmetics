...
@Component({
  selector: 'app-genyal-polyvalent',
  templateUrl: './genyal-polyvalent.component.html',
  styleUrls: ['./genyal-polyvalent.component.scss']
})
export class GenyalPolyvalentComponent implements OnInit {
