...
@Component({
  selector: 'app-genyal-volume',
  templateUrl: './genyal-volume.component.html',
  styleUrls: ['./genyal-volume.component.scss']
})
export class GenyalVolumeComponent implements OnInit {
