...
@Component({
  selector: 'app-xcelens3-details',
  templateUrl: './xcelens3-details.component.html',
  styleUrls: ['./xcelens3-details.component.scss']
})
export class Xcelens3DetailsComponent implements OnInit {
